...
export interface sprite{
  sprite_sheet:CanvasImageSource | ImageData,
  sprite_sheet_buffer?:ArrayBuffer,
  name:string,
  left:number,
  top:number,
  sprite_width:number,
...
export interface passed_sprite{
  left:number,
  top:number,
  sprite_width:number,
  sprite_height:number,
...
export function sprite_gen(obj:obj,sprite_width:number,sprite_height:number):Array<Array<sprite>> {
